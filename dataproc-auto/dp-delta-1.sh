...
yc dataproc cluster create ${YC_CLUSTER} \
  ...
  --subcluster name="static",role='computenode',resource-preset='m3-c16-m128',preemptible=false,disk-type='network-ssd',disk-size=200,hosts-count=1,subnet-name=${YC_SUBNET} \
