...
yc dataproc cluster create ${YC_CLUSTER} \
  ...
  --subcluster name="compute",role='computenode',resource-preset='s2.medium',disk-type='network-hdd',disk-size=150,hosts-count=0,max-hosts-count=1,subnet-name=${YC_SUBNET} \
...
# UPDATE "DBS" SET "DB_LOCATION_URI"='s3a://dproc-wh/wh/default.db' WHERE "DB_ID"=1;
