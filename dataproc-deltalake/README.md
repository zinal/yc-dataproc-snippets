...
**Важное замечание.** Программное обеспечение [Delta Lake](https://delta.io) и кастомизации, предлагаемые в этом репозитории, не являются частью сервиса [Yandex Data Proc](https://cloud.yandex.ru/services/data-proc), и не сопровождаются командой разработки и службой поддержки этого сервиса.
