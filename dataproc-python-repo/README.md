...
> [!NOTE]
> Приведённый в этом разделе материал дублирует информацию в [разделе официальной документации Yandex Data Proc](https://cloud.yandex.ru/docs/data-proc/operations/python-env).
